...
export default function UploadPdfPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await resourcesApi.uploadPdf(subject, title, file);
            if (response.success) {
        ...
        <div className="min-h-screen gradient-bg gradient-faculty">
            ...
            <div className="sidebar">
                ...
                <nav className="sidebar-nav">
                    ...
                    <li className="sidebar-item">
                        <Link href="/faculty/upload-pdf" className="sidebar-link active">
                            <span>📄</span>
                            Upload PDF
                        </Link>
                    </li>
                ...
                <div className="max-w-lg">
                    ...
                    <div className="card">
                        ...
                        <p className="text-gray-500 text-sm mb-6">
                            Upload lecture notes, resources, or any PDF document. The file will be encrypted
                            and digitally signed automatically.
                        </p>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    type="text"
                                    className="input"
                                    placeholder="e.g., Week 5 - Digital Signatures"
                                    value={title}
                                    ...
                                    <label htmlFor="file-upload" className="cursor-pointer">
                                        {file ? (
                                            ...
                                            <>
                                                ...
                                                <p className="text-sm text-gray-600 mt-1">or drag and drop here</p>
                                            </>
                                        )}
                                    </label>
                                </div>
                        ...
                        <div className="mt-6 p-4 rounded-lg bg-purple-500/10 border border-purple-500/20">
                            <p className="text-sm text-purple-400">
                                🔒 The file will be encrypted with <strong>AES-256</strong> and signed with
                                <strong> RSA-PSS</strong>. Students can download and decrypt it.
                            </p>
                        </div>
                    </div>
                </div>
